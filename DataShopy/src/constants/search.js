...
// exist yet, by combining three layers (in increasing "leniency"):
//   1. Exact phrase match anywhere in name/category/description.
//   2. Word-level prefix/substring match (e.g. "helado" <-> "heladería").
//   3. Word-level fuzzy match by edit distance, for typos and near-misses.
...
// by layers 2-3 without needing an entry here.
const SEARCH_SYNONYMS = {
  ...
  mascota: ['veterinaria', 'petshop', 'animales'],
